  ...
  return (
    <div>
      ...
      <p>
        ...
        l'administration des ventes, du commerce et l'export, j'ai décidé de me
      ...
      <p>
        {" "}
        A la suite de cette formation, qui m'a permis d'acquérir des compétences
        solides en développement web, souhaitant donner à ma carrière une
        direction tournée vers le digital, j'ai le plaisir de vous faire part de
        mon souhait de poursuivre ma carrière au sein de votre société en tant
        que Développeur web. J’ai acquis des compétences opérationnelles et une
        connaissance de divers langages techniques et méthodologies recherchés,
        qui me permettront d’être rapidement efficace.
      </p>
      <p>
